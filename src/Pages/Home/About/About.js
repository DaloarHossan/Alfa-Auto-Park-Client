		...
		<div className='grid md:grid-cols-2 gap-4 mt-8 ml-4'>
			...
			<div>
				...
				<div className='grid grid-cols-2 mt-6 gap-x-2 gap-y-6' >
					<div>
						<p><FontAwesomeIcon className='text-4xl'  icon={faSearch}/></p>
					...
					<div>
					<p><FontAwesomeIcon className='text-4xl'  icon={faPaperPlane}/></p>
					...
					<div>
					<p><FontAwesomeIcon className='text-4xl'  icon={faPhone}/></p>
						<h1 className='text-2xl font-semibold'>Support 24/7</h1>
						<p>Our customer or Client service active 24/7 </p>
					</div>
					<div>
					<p><FontAwesomeIcon className='text-4xl'  icon={faCar}/></p>
